...
if __name__ == '__main__':
    ...
    vaVendorRatingScrapingEvents = aParserBase.select_vendor_profile_scraping_event(n_last_parsed_scraping_event_ID_vr)
    ...
    for aVendorRatingScrapingEvent in vaVendorRatingScrapingEvents:
        ...
        s_vendor_rating_file_path = aVendorRatingScrapingEvent['vendor_profile_file_path_in_FS']
        ...
        aOneParser.m_s_html_file_name_vr = aOneParser.m_sRemoteRootDirectoryVendorProfile + s_vendor_rating_file_path
