...
from parser_asean import parser_asean  # You need to update this (Place 1) for a new Market!
...
if __name__ == '__main__':
    ...
    for aProductDescScrapingEvent in vaProductDescScrapingEvents:
        ...
        nIndexOfProgress += 1
        aOneParser = parser_asean()  # You need to update this (Place 3) for a new Market!
